...
# sysfonts::font_add(
#   family = "antonio",
#   regular = here("ttf", "antonio-regular.ttf"),
#   bold = here("ttf", "antonio-bold.ttf"),
#   symbol = NULL
# )

# sysfonts::font_add(
#   family = "barlow",
#   regular = here("ttf", "barlow-regular.ttf"),
#   bold = here("ttf", "barlow-bold.ttf"),
#   italic = here("ttf", "barlow-italic.ttf"),
#   bolditalic = here("ttf", "barlow-bolditalic.ttf"),
#   symbol = NULL
# )

# sysfonts::font_add(
#   family = "spacemono",
#   regular = here("ttf", "spacemono-regular.ttf"),
#   bold = here("ttf", "spacemono-bold.ttf"),
#   italic = here("ttf", "spacemono-italic.ttf"),
#   bolditalic = here("ttf", "spacemono-bolditalic.ttf"),
#   symbol = NULL
# )
